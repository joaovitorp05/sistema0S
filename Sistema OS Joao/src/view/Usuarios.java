...
public class Usuarios extends JDialog {
	...
	public Usuarios() {
		...
		txtLogin.setBounds(78, 181, 179, 20);
		...
		btnLimpar.setBounds(317, 346, 75, 52);
		...
		btnBuscar.setBounds(280, 87, 46, 37);
		...
		btnadicionar.setBounds(41, 348, 60, 50);
		...
		btnEditar.setBounds(127, 348, 60, 50);
		...
		btnExcluir.setBounds(222, 348, 60, 50);
		getContentPane().add(btnExcluir);
		
		lblNewLabel = new JLabel("Perfil");
		lblNewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		lblNewLabel.setBounds(294, 183, 46, 14);
		...
		chckSenha.setBounds(27, 287, 133, 23);
		getContentPane().add(chckSenha);
		
		scrollPane = new JScrollPane();
		scrollPane.setVisible(false);
		scrollPane.setBounds(67, 111, 179, 42);
