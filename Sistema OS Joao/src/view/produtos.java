...
public class produtos extends JDialog {
	...
	public produtos() {
		...
		txtFornecedor.setDocument(new Validador(30));
		...
		lblFoto.setIcon(new ImageIcon(produtos.class.getResource("/img/cameraicon.png")));
		...
		btnLimpar.setBounds(37, 473, 89, 60);
		...
		btnEditar.setBounds(122, 473, 89, 60);
		...
		btnAdicionar.setBounds(219, 473, 89, 60);
		...
		btnExcluir.setBounds(315, 473, 89, 60);
